...
const server = new proxyServer (setup.whiteList, setup.domainListPool, setup.localServerPort, setup.socketPath, setup.gatewayIP, setup.gatewayPort, setup.randomPassword,
	setup.checkAgainTimeOut, setup.connectTimeOut, setup.AllDataToGateway, setup.domainBlackList)
